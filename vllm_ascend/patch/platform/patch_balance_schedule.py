...
disabled fast path forwards Prefill admission constraints to upstream
when supplied; the default call retains compatibility with the pinned release.
...
class BalanceScheduler(Scheduler):
    ...
    def schedule(
        ...
        *,
        ...
        if self._balance_enabled and (
            not admit_new_prefills or separate_prefill_quota
        ):
            raise ValueError(
